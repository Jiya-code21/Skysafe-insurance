...
//               <img src="/logo.png" alt="SkySafe" className="animate-pulse-ring w-10 h-10 object-contain rounded-xl" />
...
//                 <img src="/logo.png" alt="SkySafe" className="w-16 h-16 object-contain rounded-2xl mx-auto mb-6" />
...
//               <img src="/logo.png" alt="SkySafe" className="w-8 h-8 object-contain rounded-lg" />
    ...
    <>
      ...
      <div className="home-root min-h-screen flex flex-col mesh-bg overflow-x-hidden">
        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          ...
          <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5 group">
              <img src="/logo.png" alt="SkySafe" className="animate-pulse-ring w-12 h-12 object-contain drop-shadow-lg" />
              <span className="font-sora text-xl font-bold text-slate-800">
                Sky<span className="text-blue-600">Safe</span>
              </span>
            </Link>
        ...
        <section className="relative z-10 py-20 px-4 mb-8">
          <div className="max-w-3xl mx-auto section-fade">
            <div className="relative rounded-3xl overflow-hidden">
              ...
              <div className="relative z-10 p-12 text-center">
                <img src="/logo.png" alt="SkySafe" className="w-20 h-20 object-contain mx-auto mb-6 drop-shadow-xl" />
                <h2 className="font-sora text-4xl font-extrabold text-white mb-4">
                  Ready to stop worrying?
                </h2>
                <p className="text-blue-100 mb-10 max-w-lg mx-auto text-base">
        ...
        <footer className="relative z-10 border-t border-slate-100 py-8 px-4">
          <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              <img src="/logo.png" alt="SkySafe" className="w-10 h-10 object-contain" />
              <span className="font-sora font-bold text-slate-800">
                Sky<span className="text-blue-600">Safe</span>
              </span>
            </div>
